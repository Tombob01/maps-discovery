...
import type { BusinessID, ExportFormat, QueryHash, QueryID, RunID, StageCheckpointStatus, UUID, RunStatus } from "../types/common.js";
import type { ResumeToken } from "../types/pagination.js";
export type QueueName = "query:generate" | "query:expand" | "discovery" | "normalization" | "deduplication" | "export";
...
export type JobPayload = QueryGenerationJobPayload | QueryExpansionJobPayload | DiscoveryJobPayload | NormalizationJobPayload | DeduplicationJobPayload | ExportJobPayload;
