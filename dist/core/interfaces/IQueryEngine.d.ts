 ...
 */
import type { GeneratedQuery, CanonicalizedQuery, QueryIdentityParts, QuerySeed, ResolvedQuery, ExpansionContext } from "../models/Query.js";
...
export interface IQueryEngine {
     ...
     */
    generate(seed: QuerySeed): Promise<Result<readonly GeneratedQuery[], QueryEngineErrorDetail>>;
}
...
export interface IGeoResolver {
     ...
     */
    resolve(target: import("../types/geo.js").GeoTarget): Promise<Result<ResolvedGeoTarget, GeoResolutionErrorDetail>>;
}
/**
...
export type CanonicalizationErrorCode = "HASH_COMPUTATION_FAILED" | "EMPTY_CANONICAL_TEXT" | "INVALID_QUERY";
...
import type { QueryEngineErrorCode, GeoResolutionErrorCode } from "../errors/PipelineError.js";
export type QueryExpanderErrorCode = "STRATEGY_FAILED" | "ALL_STRATEGIES_FAILED" | "MAX_VARIANTS_REACHED";
export type ExpansionStrategyErrorCode = "EXTERNAL_CALL_FAILED" | "RATE_LIMITED" | "PARSE_FAILED" | "UNKNOWN";
...
//# sourceMappingURL=IQueryEngine.d.ts.map