...
export interface IFieldNormalizer<TRaw, TOut> {
    normalize(raw: TRaw, context: NormalizationContext): Result<TOut, FieldNormalizationErrorDetail>;
}
/**
...
export type FieldNormalizationErrorCode = "PARSE_FAILED" | "INVALID_FORMAT" | "OUT_OF_RANGE" | "EMPTY_VALUE";
export type MappingErrorCode = "INVALID_PAYLOAD_SHAPE" | "MISSING_REQUIRED_KEY" | "UNEXPECTED_TYPE";
...
//# sourceMappingURL=INormalizer.d.ts.map