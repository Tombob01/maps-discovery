...
export function isOk(r) { return r.ok; }
export function isErr(r) { return !r.ok; }
export const NONE = { some: false };
export function some(value) { return { some: true, value }; }
export function isSome(o) { return o.some; }
export function isNone(o) { return !o.some; }
