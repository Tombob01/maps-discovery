...
export class BusinessNormalizer {
    ...
    async normalize(result, context) {
        ...
        const fields = mappingResult.value;
        // 3. Name is required
        ...
        const normalizedPhone = isOk(phoneResult)
            ? phoneResult.value
            : null;
        // 5. Normalise address (graceful degradation)
        // Build without undefined values â€” exactOptionalPropertyTypes requires this
        const addressInput = Object.assign({}, fields.addressRaw !== undefined
            ? { addressRaw: fields.addressRaw }
            : {}, fields.street !== undefined ? { street: fields.street } : {}, fields.city !== undefined ? { city: fields.city } : {}, fields.state !== undefined ? { state: fields.state } : {}, fields.postalCode !== undefined
        ...
        const priceLevel = rawPrice === 1 || rawPrice === 2 || rawPrice === 3 || rawPrice === 4
            ? rawPrice
            : null;
        // 8. Geo
        const geo = typeof fields.lat === "number" && typeof fields.lng === "number"
        ...
        const fingerprint = fingerprintRecord(partial);
        const id = fingerprint; // id assigned later by persistence layer
        const record = {
            ...partial,
            id,
            fingerprint,
...
//# sourceMappingURL=BusinessNormalizer.js.map