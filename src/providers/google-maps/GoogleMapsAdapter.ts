...
export class GoogleMapsAdapter {
   ...
   */
  async getCardListingUrl(card: ElementHandle): Promise<string | undefined> {
  ...
  async extractFromCard(
    ...
    return this._extractFromDetailPanel(
      page,
      listingUrl,
      searchQuery,
      resultPosition,
   ...
   */
  private async _extractFromCardOnly(
    card: ElementHandle,
    searchQuery: string,
    resultPosition: number,
  ): Promise<GoogleMapsRawPayload> {
   ...
   */
  private async _extractFromDetailPanel(
    page: Page,
  ...
  private async _extractWebsite(page: Page): Promise<string | undefined> {
    return getAttribute(page, sel("websiteRow"), "href");
  }

  private async _extractOpenStatus(page: Page): Promise<string | undefined> {
  ...
  private async _tryExpandHours(page: Page): Promise<void> {
    try {
  ...
  private async _extractHoursRaw(page: Page): Promise<string[]> {
    try {
...
function buildPayload(partial: {
  ...
  reviewCountText?: string | undefined;
  categoryText?: string | undefined;
  priceLevelText?: string | undefined;
  openStatusText?: string | undefined;
  hoursRaw?: string[] | undefined;
  coordinates?: { lat: number; lng: number } | undefined;
  searchQuery?: string | undefined;
  resultPosition?: number | undefined;
  detailPanelScraped?: boolean | undefined;
}): GoogleMapsRawPayload {
  const result: GoogleMapsRawPayload = {};
  if (partial.placeId !== undefined) result.placeId = partial.placeId;
  if (partial.listingUrl !== undefined) result.listingUrl = partial.listingUrl;
  if (partial.name !== undefined) result.name = partial.name;
  if (partial.address !== undefined) result.address = partial.address;
  if (partial.phone !== undefined) result.phone = partial.phone;
  if (partial.website !== undefined) result.website = partial.website;
  if (partial.ratingText !== undefined) result.ratingText = partial.ratingText;
  ...
  if (partial.hoursRaw !== undefined) result.hoursRaw = partial.hoursRaw;
