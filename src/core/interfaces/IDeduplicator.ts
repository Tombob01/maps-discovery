...
// ---------------------------------------------------------------------------
// IDeduplicator — top-level contract
// ---------------------------------------------------------------------------
...
export interface IDeduplicator {
  ...
  ): Promise<Result<DeduplicationResult, DeduplicationErrorDetail>>;
  ...
  markSeen(
    record: BusinessRecord,
  ): Promise<Result<void, DeduplicationErrorDetail>>;
}
...
// ---------------------------------------------------------------------------
// IFingerprintGenerator — produces stable Fingerprint hashes
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Error types — DeduplicationErrorCode lives in errors/DeduplicationError.ts
// ---------------------------------------------------------------------------
