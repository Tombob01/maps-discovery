...
export interface GeoCoordinates {
  readonly lat: number; // -90 to 90
  readonly lng: number; // -180 to 180
}
...
// ---------------------------------------------------------------------------
// Geo target — used by query engine to express intent
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Administrative region (for future region-expansion strategies)
// ---------------------------------------------------------------------------

export interface AdminRegion {
  readonly name: string;
  readonly code: string; // e.g. "NG-KT"
