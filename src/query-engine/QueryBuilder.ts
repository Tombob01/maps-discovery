...
import type { QueryID, RunID } from "../core/types/common.js";
...
export class QueryBuilder {
  constructor(private readonly canonicalizer: IQueryCanonicalizer) {}
  ...
  build(seed: QuerySeed, runId: RunID, providerId: string): GeneratedQuery {
    ...
    const query: GeneratedQuery = Object.freeze({
 ...
 */
function composeRawText(seed: QuerySeed): string {
  const parts: string[] = [];
