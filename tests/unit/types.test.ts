...
describe("Result — isOk() and isErr()", () => {
...
describe("Option — isSome() and isNone()", () => {
...
describe("QueryLifecycleState", () => {
  ...
  it("states match expected forward-progression order", () => {
    // generated → canonicalized → queued → dispatched → running → terminal
    const ordered = [
      "generated",
      "canonicalized",
      "queued",
...
// ---------------------------------------------------------------------------
// Pagination types — structural shape verification
// ---------------------------------------------------------------------------

describe("Pagination types — structural shape", () => {
